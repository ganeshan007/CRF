...
def load_a2g_data():
    ...
    tag_set=set()
    speaker_set=set()
    f=['C:/Users/Ganeshan/Desktop/CRF/dataset/a2g_test.csv','C:/Users/Ganeshan/Desktop/CRF/dataset/a2g_train.csv','C:/Users/Ganeshan/Desktop/CRF/dataset/a2g_valid.csv']
    for file in f:
        df=pd.read_csv(file)
        a=df['ID'].str.split('_')
        l=[k[0] for k in a]
